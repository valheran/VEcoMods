...
namespace Eco.Mods.TechTree
{
    ...
    [RequiresSkill(typeof(AdvancedMiningSkill), 2)]   //_If_ReqLevel_
    ...
    public partial class AirlegRecipe : Recipe
    {
        public AirlegRecipe()
        {
            ...
            {
                new CraftingElement<IronIngotItem>(typeof(AdvancedMiningEfficiencySkill), 40, AdvancedMiningEfficiencySkill.MultiplicativeStrategy),
                new CraftingElement<CopperIngotItem>(typeof(AdvancedMiningEfficiencySkill), 10, AdvancedMiningEfficiencySkill.MultiplicativeStrategy),
            };
            this.CraftMinutes = CreateCraftTimeValue(typeof(AirlegRecipe), Item.Get<AirlegItem>().UILink(), 30, typeof(AdvancedMiningSpeedSkill));
    ...
    public class AirlegItem : ToolItem
    {
        ...
        private float MaxDrill = 20; //maximum drill range  may be able to hook this in with drilling efficieny additive strategy at some point to extend range
