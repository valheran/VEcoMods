namespace Eco.Mods.TechTree
{
    ...
    [Serialized]
    [RequiresSkill(typeof (ChloralkaliEfficiencySkill), 1)]
    public partial class ChloralkaliSpeedSkill : Skill
    {
        public override string FriendlyName { get { return "Chloralkali Speed"; } }
        ...
        public static int[] SkillPointCost = { 5, 5, 5, 8, 10 }; 
