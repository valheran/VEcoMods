namespace Eco.Mods.TechTree
{
    ...
    public partial class LeachingLiquorRecipe : Recipe
    {
        public LeachingLiquorRecipe()
        {
            ...
            {
                new CraftingElement<WoodPulpItem>(typeof(MetallurgyEfficiencySkill), 10, MetallurgyEfficiencySkill.MultiplicativeStrategy),
                new CraftingElement<PitchItem>(typeof(MetallurgyEfficiencySkill), 10, MetallurgyEfficiencySkill.MultiplicativeStrategy),//placeholder, maybe try for making acid out of smelter gas
            };
            this.CraftMinutes = CreateCraftTimeValue(typeof(LeachingLiquorRecipe), Item.Get<LeachingLiquorItem>().UILink(), 2, typeof(MetallurgySpeedSkill));
