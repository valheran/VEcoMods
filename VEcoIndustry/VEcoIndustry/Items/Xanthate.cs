namespace Eco.Mods.TechTree
{
    ...
    public partial class XanthateRecipe : Recipe
    {
        public XanthateRecipe()
        {
            ...
            {
                new CraftingElement<PetroleumItem>(typeof(MetallurgyEfficiencySkill), 1, MetallurgyEfficiencySkill.MultiplicativeStrategy), //add sulphuric if ever implement
            };
            this.CraftMinutes = CreateCraftTimeValue(typeof(XanthateRecipe), Item.Get<XanthateItem>().UILink(), 2, typeof(MetallurgySpeedSkill));
