...
namespace Eco.Mods.TechTree
{
    ...
    [RequiresSkill(typeof(DrillingSkill), 3)]   //_If_ReqLevel_
    [RepairRequiresSkill(typeof(DrillingSkill), 4)]
    public partial class ProspectorRecipe : Recipe
    {
        public ProspectorRecipe()
        {
            ...
            {
                new CraftingElement<CopperIngotItem>(typeof(DrillingEfficiencySkill), 40, DrillingEfficiencySkill.MultiplicativeStrategy),
                new CraftingElement<IronPipeItem>(typeof(DrillingEfficiencySkill), 50, DrillingEfficiencySkill.MultiplicativeStrategy),
            };
            this.CraftMinutes = CreateCraftTimeValue(typeof(ProspectorRecipe), Item.Get<ProspectorItem>().UILink(), 30, typeof(DrillingSpeedSkill));
    ...
    public class ProspectorItem : ToolItem
    {
        ...
        private static SkillModifiedValue skilledRepairCost = new SkillModifiedValue(50, DrillingSkill.MultiplicativeStrategy, typeof(DrillingSkill), Localizer.Do("repair cost"));
        public override IDynamicValue SkilledRepairCost { get { return skilledRepairCost; } }
        public override float DurabilityRate { get { return DurabilityMax / 50f; } }
        private static SkillModifiedValue caloriesBurn = CreateCalorieValue(500, typeof(DrillingEfficiencySkill), typeof(ProspectorItem), new ProspectorItem().UILink());
